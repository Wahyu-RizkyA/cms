...
@section('content')
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="{{url('assets/images/boksing-gloves.png')}}" alt="img"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="carousel-item active">
                  <div class="container">
                     <div class="row marginii">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                           <div class="img-box">
                              <figure><img src="{{url('assets/images/child-image.png')}}" style="max-width: 100%; border: 15px solid #fff;"/></figure>
                           </div>
                        </div>
                     </div>
                  </div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="titlepage">
                           <div class="john">
                              <div class="john_image"><img src="{{url('assets/images/john-image.png')}}" style="max-width: 100%;"></div>
                              ...
                              <div class="icon_image"><img src="{{url('assets/images/icon-1.png')}}"></div>
                           </div>
                        </div>
    </div>
    <div class="carousel-item">
  ...
  <a class="carousel-control-next" href="#testimonial" data-slide="next">
    ...
    <div id="footer" class="Address layout_padding">
               ...
               <div class="address_2">
                  <div class="row">
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="{{url('assets/images/map-icon.png')}}" /></span>
                          <span style="margin-top: 10px;">No.123 Chalingt Gates, Supper market New York</span></div>
                     </div>
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="{{url('assets/images/phone-icon.png')}}" /></span>
                          <span style="margin-top: 21px;">( +71 7986543234 )</span></div>
                     </div>
                     <div class="col-sm-12 col-md-12 col-lg-4">
                       <div class="site_info">
                          <span class="info_icon"><img src="{{url('assets/images/email-icon.png')}}" /></span>
      ...
      <!-- javascript --> 
      <script href="{{url('assets/js/owl.carousel.js')}}"></script>
